/**
 * T5-6/T5-7 · 간이 한국어 토큰 추출.
 * 형태소 분석기 없이 조사·어미를 잘라 명사에 가까운 토큰만 남긴다.
 * (운영에서 정확도를 더 올리려면 Functions 쪽에 mecab/khaiii 계열을 붙인다.)
 */
...
/** 기본 불용어에 더해, 집계에서 제외할지 설정으로 켜고 끄는 단어 (PROMPT T5-7) */
...
/** 금칙어 필터 (T5-6) — 운영에서는 관리자 화면에서 목록을 관리한다. */
